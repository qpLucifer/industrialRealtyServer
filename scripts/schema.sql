...
CREATE TABLE properties (
  ...
  featured TINYINT(1) NOT NULL DEFAULT 0 COMMENT '主推（仅出售有效）',
...
INSERT INTO code_master (type_code, item_code, label, sort_order, is_active) VALUES
  ...
  ('property_status_tag', 'pending_dev', '待开发', 35, 1),
  ('property_status_tag', 'for_rent', '出租', 40, 1),
  ('property_status_tag', 'rented', '已租', 50, 1),
  ('property_status_tag', 'for_sale', '出售', 60, 1),
  ...
  ('property_listing_status', 'pending_dev', '待开发', 8, 1),
  ('property_listing_status', 'for_rent', '出租', 10, 1),
  ('property_listing_status', 'rented', '已租', 20, 1),
  ('property_listing_status', 'for_sale', '出售', 30, 1),
...
CREATE TABLE property_privacy_grants (
  ...
  can_edit_property TINYINT(1) NOT NULL DEFAULT 0,
  remark VARCHAR(255) NULL,
...
CREATE TABLE industrial_land_auctions (
  ...
  transfer_term VARCHAR(64) NULL COMMENT '出让年限',
  tax_per_mu DECIMAL(14, 4) NULL COMMENT '亩产税',
  investment_per_mu DECIMAL(14, 4) NULL COMMENT '亩产投资',
  deposit_wan DECIMAL(14, 2) NULL COMMENT '保证金（万元）',
  start_price_wan DECIMAL(14, 2) NULL,
  deal_price_wan DECIMAL(14, 2) NULL,
  avg_price_per_mu DECIMAL(14, 2) NULL COMMENT '均价（万元/亩）',
  buyer_info VARCHAR(512) NULL COMMENT '买方信息',
